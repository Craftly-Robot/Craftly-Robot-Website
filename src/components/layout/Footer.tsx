      ...
      <div className="container container--wide">
        <div className="footer__inner">
          ...
          <div className="footer__brand">
            <Link to="/" aria-label="Craftly Home">
              <img
            ...
            <p className="footer__tagline">{siteContent.footer.tagline}</p>
          </div>
          ...
          <div>
            ...
            <div className="footer__links">
              {products.map((p) => (
                <Link key={p.id} to={p.route} className="footer__link">
                  {p.name}
                </Link>
              ))}
            </div>
          ...
          {/* Use Cases */}
          <div>
            <h3 className="footer__section-title">Use Cases</h3>
            <div className="footer__links">
              {useCases.map((uc) => (
                <Link key={uc.id} to={uc.route} className="footer__link">
                  {uc.title}
                </Link>
              ))}
            </div>
          ...
          <div>
            ...
            <div className="footer__links">
              {resources.map((r) => (
                <Link key={r.id} to={r.route} className="footer__link">
                  {r.title}
                </Link>
              ))}
            </div>
