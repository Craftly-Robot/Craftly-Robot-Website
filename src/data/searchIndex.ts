...
export const searchIndex: SearchItem[] = [
  // Marketing Pages
  { title: "Home", description: "Craftly — The operating system for intelligent organizations", route: "/", category: "pages" },
  { title: "Download", description: "Download Craftly Workspace for macOS, Windows, Linux, and Android", route: "/download", category: "pages" },
  { title: "Vision", description: "The Craftly plan: Workspace → Robot → Glass", route: "/vision", category: "pages" },
  ...
  // Resource Pages
  { title: "Documentation", description: "Learn how to use Craftly products", route: "/resources/documentation", category: "pages" },
  ...
  { title: "Tasks", description: "Task management in Craftly", route: "/resources/documentation/workspace/tasks-operations/tasks", category: "docs" },
  { title: "Task Assignment", description: "How to assign tasks", route: "/resources/documentation/workspace/tasks-operations/task-assignment", category: "docs" },
  { title: "Notices", description: "Creating and managing notices", route: "/resources/documentation/workspace/tasks-operations/notices", category: "docs" },
  { title: "Support Requests", description: "Handling support requests", route: "/resources/documentation/workspace/tasks-operations/support-requests", category: "docs" },
  { title: "Operational Workflows", description: "Setting up workflows", route: "/resources/documentation/workspace/tasks-operations/operational-workflows", category: "docs" },
  { title: "Department Resources", description: "Managing department resources", route: "/resources/documentation/workspace/resources/dept-resources", category: "docs" },
  { title: "Organization Resources", description: "Managing organization-wide resources", route: "/resources/documentation/workspace/resources/org-resources", category: "docs" },
  { title: "Training", description: "Training resources and materials", route: "/resources/documentation/workspace/resources/training", category: "docs" },
  { title: "Agent Model", description: "Craftly Robot agent architecture", route: "/resources/documentation/robot/overview/agent-model", category: "docs" },
  { title: "Current Status", description: "Robot development status", route: "/resources/documentation/robot/overview/current-status", category: "docs" },
  { title: "Agentic AI", description: "Understanding agentic AI in Craftly", route: "/resources/documentation/robot/feature-overview/agentic-ai", category: "docs" },
