...
export const useCases: UseCase[] = [
  {
    ...
    areas: ["Task Management", "Communication", "Operations", "Resources", "Workflows"],
  ...
  },
  {
    ...
    concept: "Enable intelligent agents to communicate, coordinate, and negotiate.",
    description:
    ...
    areas: ["Agent Communication", "Coordination", "Delegation", "Negotiation", "Decision Systems"],
  ...
  },
  {
    ...
    areas: ["Engineering", "Operations", "Research", "Security", "Business Intelligence"],
    route: "/use-cases/ai",
    icon: "ai",
  },
];
