...
export const products: Product[] = [
  {
    ...
    description:
      'Craftly Workspace brings people, work, and operations together in one connected system. It helps teams coordinate tasks, communicate clearly, and keep work moving.',
    icon: 'workspace',
