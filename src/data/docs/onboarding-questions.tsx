...
/** Content extracted from OnboardingQuestionsPage. Rendered by the page. */
      ...
      textAbove: (
        <>
          ...
          <p className="docs__text" style={{ marginBottom: "16px" }}>
            <strong>Expected answer:</strong> Full legal name only.
          </p>
        </>
      ),
      textBelow: "",
    },
    {
      ...
      textAbove: (
        <>
          ...
          <p className="docs__text">
            Choose the option that best describes you from the available
            choices, then confirm your selection when the assistant asks you to
            verify it.
          </p>
          <div
            style={{
    ...
    },
    {
      ...
      textAbove: (
        <>
          ...
          <p className="docs__text">
            The onboarding assistant will ask about your current education
            level. Choose the option that best describes where you currently
            study.
          </p>
          <p className="docs__text">
    ...
    },
    {
      ...
      textAbove: (
        <>
          ...
          <p className="docs__text">
            The onboarding assistant will ask for the name of your current
            school, college, or university. Enter the institution’s full name as
            you normally use it.
          </p>
          <div
            style={{
    ...
    },
    {
      ...
      textAbove: (
        <>
          ...
          <p className="docs__text">
            The onboarding assistant will ask for your WhatsApp number so
            Craftly can use it for relevant communication during and after
            onboarding. Enter a valid 11-digit Bangladeshi WhatsApp number.
          </p>
          ...
          <p className="docs__text" style={{ marginBottom: "16px" }}>
            The assistant will repeat the number and ask you to confirm that it
    ...
    },
    {
      ...
      textAbove: (
        <>
          ...
          <p className="docs__text">
            Provide the email address you currently use and can be reached at.
          </p>
          <div
            style={{
              backgroundColor: "#f8f9fa",
    ...
    },
    {
      ...
      textAbove: (
        <>
          ...
          <p className="docs__text" style={{ marginBottom: "16px" }}>
            Choose the department you want to work in Operations, Human
            Resources, Marketing, or Finance.
          </p>
        </>
      ),
      textBelow: "",
    ...
    },
    {
      ...
      textAbove: (
        <>
          ...
          <p className="docs__text">
            <strong>Question:</strong> How would you accomplish 30 days' worth
            of work in six hours?
          </p>
          <p className="docs__text">
    ...
    },
    {
      ...
      textAbove: (
        <>
          ...
          <p className="docs__text">
            <strong>Answer:</strong> Provide a clear prompt that defines the
            AI's role, the project context, the exact task, requirements,
    ...
    },
    {
      ...
      textAbove: (
        <>
          ...
          <p className="docs__text">
            <strong>Answer:</strong> Reply with one of the available options:
            With a mentor, or Independently.
          </p>
          <div
            style={{
              backgroundColor: "#f8f9fa",
        ...
        <>
          ...
          >
            ...
            <p style={{ margin: 0, fontSize: "15px" }}>
              ...
              workflows, and solving problems efficiently. I want to help the
              team execute work faster and more effectively.
            </p>
          </div>
        </>
      ),
      ...
      textAbove: (
        <>
          ...
          >
            ...
            <p style={{ margin: 0, fontSize: "15px" }}>
              Building and managing complex AI projects from scratch while
              solving technical problems independently and delivering working
    ...
    },
    {
      ...
      textAbove: (
        <>
          ...
          <p className="docs__text">
            <strong>Question:</strong> What is the hardest technical milestone
            you have achieved?
          </p>
          <div
            style={{
          ...
          >
            ...
            <p style={{ margin: 0, fontSize: "15px" }}>
              Mastering real-time context switching and multimodal AI
              integration while maintaining accurate reasoning, fast execution,
      ...
      textAbove: (
        <>
          ...
          >
            ...
            <p style={{ margin: 0, fontSize: "15px" }}>
              I will handle the situation strategically and professionally. I
              will avoid engaging in unnecessary arguments, verify the
              information, and report or escalate the issue to the appropriate
              team so that the correct response can be taken.
            </p>
          </div>
        </>
      ),
    ...
    },
    {
      ...
      textAbove: (
        <>
          ...
          <p className="docs__text">
            <strong>Question:</strong> If a leader or someone above you
            instructs you to do something unfair according to Craftly’s
            Constitution, what will you do?
          </p>
          <div
            style={{
              backgroundColor: "#f8f9fa",
