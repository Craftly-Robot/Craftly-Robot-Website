      ...
      <div className="container">
        <section className="product-hero-clean">
          ...
          <p className="product-hero-clean__desc">
            Bangladesh&apos;s first AI company. Building the operating system for intelligent
            organizations.
          </p>
        </section>
      </div>
      ...
      <section className="explore-features-section">
        <div className="product-showcase-large product-showcase-large--no-margin">
          <div className="section-content">
            ...
            <p
              className="vision-stage__desc reveal reveal-delay-1"
              style={{ fontSize: "1.125rem" }}
            >
              Technology should help people coordinate, create, and accomplish meaningful work at
              scale without losing sight of the people doing that work.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="product-showcase-large product-showcase-large--no-margin">
          <div className="section-content">
            ...
            <p className="abstracted-ui-desc reveal reveal-delay-1">
              Craftly was founded in Bangladesh with a simple belief: the future of work is
              intelligent, connected, and organized. We&apos;re building systems that help
              organizations run better, teams communicate clearer, and work move faster.
            </p>
            <p className="abstracted-ui-desc reveal reveal-delay-2">
              Starting with Craftly Workspace — a platform that connects people, tasks,
              communication, and resources in one structured environment. Then expanding into
              autonomous AI with Craftly Robot. And ultimately, connecting it all to the physical
              world with Craftly Glass.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="abstracted-ui-grid">
            <div className="abstracted-ui-feature reveal reveal-delay-1">
              ...
              <p className="abstracted-ui-feature__desc">
                Simple systems that work are better than complex systems that confuse. We build for
                clarity.
              </p>
            </div>
            <div className="abstracted-ui-feature reveal reveal-delay-2">
              ...
              <p className="abstracted-ui-feature__desc">
                Technology should serve people, not the other way around. We build with people in
                mind.
              </p>
            </div>
            <div className="abstracted-ui-feature reveal reveal-delay-3">
              ...
              <p className="abstracted-ui-feature__desc">
                We say what we&apos;re building and where we are. No overclaiming. No vaporware.
      ...
      <section className="abstracted-ui-section">
        <div className="product-showcase-large product-showcase-large--no-margin">
          <div className="section-content">
            ...
            <p className="abstracted-ui-desc reveal reveal-delay-1">
              A team of engineers, designers, and builders based in Bangladesh. We&apos;re working
              to build the future of work — intelligent systems that help organizations run better.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="vision-stage reveal">
            ...
            <div className="section-actions">
              ...
              <Link
                ...
                className="btn-product-download btn-product-download--outline"
              >
                Documentation
              </Link>
            </div>
