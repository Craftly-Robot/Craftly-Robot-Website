      ...
      <div className="container">
        <section className="product-hero-clean">
          ...
          <p className="product-hero-clean__desc">
            From organizations running operations to developers building with
            AI. Craftly is built for people who need to coordinate work, communicate
            clearly, and move fast.
          </p>
        </section>
      </div>
          ...
          <div style={{ maxWidth: "1120px", margin: "0 auto" }}>
            <div className="vision-stage reveal">
              ...
              <p className="vision-stage__desc">
                Run your organization as one connected system. Craftly Workspace
            ...
            <div className="abstracted-ui-grid">
              ...
              <div className="abstracted-ui-feature reveal reveal-delay-2">
                ...
                <p className="abstracted-ui-feature__desc">
                  Create, assign, track, and complete tasks with clear ownership
                  and accountability.
                </p>
              </div>
              <div className="abstracted-ui-feature reveal reveal-delay-3">
                ...
                <p className="abstracted-ui-feature__desc">
                  Communicate through your reporting structure. Keep organizational
                  conversations clear and structured.
                </p>
              </div>
            </div>
        ...
        <div className="product-showcase-large" style={{ marginBottom: 0 }}>
          <div style={{ maxWidth: "1120px", margin: "0 auto" }}>
            <div className="vision-stage reveal">
              ...
              <p className="vision-stage__desc">
                Build with intelligent agents. Craftly Robot is being built toward
                a world where AI agents can discover relevant people and services,
                communicate across boundaries, and coordinate real world tasks.
              </p>
            </div>
            <div className="abstracted-ui-grid">
              <div className="abstracted-ui-feature reveal reveal-delay-1">
              ...
              <div className="abstracted-ui-feature reveal reveal-delay-2">
                ...
                <p className="abstracted-ui-feature__desc">
                  Keep humans in the loop for consequential actions. Agent proposals
              ...
              <div className="abstracted-ui-feature reveal reveal-delay-3">
                ...
                <p className="abstracted-ui-feature__desc">
                  Connect digital decisions to physical outcomes. APIs, databases,
                  and external tools.
                </p>
              </div>
            </div>
      ...
      <section className="workspace-options-section">
        <div className="container">
          <div className="vision-stage reveal">
            ...
            <p className="vision-stage__desc">
              Bangladesh&apos;s first AI company. We&apos;re building the future
              of work in Bangladesh and beyond. Technology should help people
              coordinate, create, and accomplish meaningful work at scale.
            </p>
          </div>
          <div className="abstracted-ui-grid">
            <div className="abstracted-ui-feature reveal reveal-delay-1">
