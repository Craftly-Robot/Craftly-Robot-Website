  ...
  return (
    ...
    >
      <p className="docs__text">
        Workspace works by connecting people, roles, work, communication, and resources into a
        single organizational system.
      </p>

      <p className="docs__text">
        A member typically enters Workspace through the onboarding process. During onboarding, the
        system collects the information required to establish the member's organizational profile
        and determine where they fit within Craftly.
      </p>

      <p className="docs__text">
        Once onboarding is completed, the member's Workspace experience is organized around their
        role, department, responsibilities, and reporting structure.
      </p>
      ...
      <p className="docs__text">
        Members also complete required agreements and digital signatures where applicable.
      </p>
      <p className="docs__text">
        A private organizational key is associated with the member as part of the identity system.
      </p>
      ...
      <p className="docs__text">
        This creates a reporting graph rather than treating every member as an isolated account.
      </p>
      ...
      <p className="docs__text">
        <strong>
          Assigned &rarr; In Progress &rarr; Evidence Submitted &rarr; Reviewed &rarr; Completed
        </strong>
      </p>
      <p className="docs__text">
        The system is designed around verifiable work, rather than simply marking something as
        "done."
      </p>
      <p className="docs__text">
        Members can provide evidence showing what they actually completed. This creates
        accountability while keeping the workflow measurable.
      </p>
      ...
      <p className="docs__text">
        Instead of creating unrestricted communication between everyone, Workspace can use the chain
        of command and reporting relationships to determine the appropriate communication path.
      </p>
      <p className="docs__text">
        This allows information to move through the organization while maintaining organizational
        boundaries.
      </p>
      <p className="docs__text">For example:</p>
      <p className="docs__text">
        <strong>Member &rarr; Team Lead &rarr; Department Leadership &rarr; Organization</strong>
      </p>
      <p className="docs__text">
      ...
      <p className="docs__text">
        Departments can maintain their own resources, documentation, and learning materials.
      </p>
      <p className="docs__text">
        Training participation can also be tracked so that Craftly can understand:
      </p>
      <ul className="docs__list">
      ...
      <p className="docs__text">
        <strong>
          People &rarr; Work &rarr; Evidence &rarr; Review &rarr; Communication &rarr; Resources
          &rarr; Better Work
        </strong>
      </p>
      <p className="docs__text">
        The purpose is not merely to store information, but to make the organization increasingly
        capable of executing work in a structured way.
      </p>
    </DocPage>
  );
}
