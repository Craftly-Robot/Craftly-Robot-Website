...
export default function AgentNegotiationPage() {
  return (
    ...
    >
      ...
      <p className="docs__text">
        The idea is simple : instead of requiring a person to manually communicate with every person
        or service involved in a task, one Robot agent can communicate with another agent to
        discover capabilities, exchange relevant requirements, determine alignment, and coordinate a
        possible solution.
      </p>
      <p className="docs__text">
        This is an important part of moving Robot from conversational AI toward real world task
        coordination.
      </p>
      <p className="docs__text">
        Modern agent interoperability research follows a similar pattern. Google's A2A protocol, for
        example, defines mechanisms for agent capability discovery, task-oriented communication,
        collaboration, and exchanging information between independent agents without requiring one
        agent to access another agent's internal state.
      </p>
      <p className="docs__text">
        Craftly Robot is developing its own identity, discovery, and agent communication model
        around this broader idea.
      </p>
      ...
      <div className="docs__code-block">
        <pre>
          User Request ↓ Requirement Understanding ↓ Agent Discovery ↓ Agent Request ↓
          Agent-to-Agent Communication ↓ Alignment / Negotiation ↓ Potential Solution ↓ Human
          Confirmation ↓ Real World Action
        </pre>
      </div>
      ...
      <blockquote className="docs__quote">
        ...
        days for under ৳15,000, and confirm whether they provide a warranty.”
      </blockquote>
      <p className="docs__text">Robot can interpret the request into requirements:</p>
      ...
      <p className="docs__text">It can then discover potentially relevant service agents.</p>
      ...
      <p className="docs__text">
        The goal is not for agents to make uncontrolled commitments. The goal is to let agents
        handle the communication and coordination work that would otherwise require significant
        human effort.
      </p>
      ...
      <p className="docs__text">
        Craftly Robot's agent-to-agent negotiation capability is currently part of active research
        and development.
      </p>
      <p className="docs__text">
        The foundational infrastructure for identity, discovery, agent communication, and
        consent-aware coordination is being developed, and early real-world workflows are being
        explored.
      </p>
      <p className="docs__text">The broader public workflow is still evolving.</p>
      <p className="docs__text">
        As the system matures, Craftly intends to make increasingly complex agent-to-agent
        interactions possible while keeping identity, privacy, permissions, and human control
