  ...
  return (
    ...
    >
      <p className="docs__text">
        Craftly Robot is designed to help automate coordination without removing people from
        important decisions.
      </p>
      <p className="docs__text">
        This is especially important when an AI interaction can lead to a consequential real world
        action.
      </p>
      ...
      <div className="docs__code-block">
        <pre>
          Understanding the request → Discovering relevant agents → Asking questions → Comparing
          information → Communicating → Negotiating possible conditions
        </pre>
      </div>
      <p className="docs__text">
      ...
      <p className="docs__text">
        When the next step would create a meaningful real-world commitment, the user remains
        responsible for giving the appropriate confirmation.
      </p>
      <p className="docs__text">The workflow can therefore become:</p>
      <div className="docs__code-block">
        <pre>
          AI Coordination ↓ Potential Outcome ↓ Human Review ↓ Explicit Confirmation ↓ Consequential
          Action
        </pre>
      </div>
      <p className="docs__text">
        This separation is important because an agent should not interpret a user's request as
        unlimited permission to take every possible action.
      </p>
      <p className="docs__text">
        The Model Context Protocol's security guidance similarly recommends keeping a human in the
        loop with the ability to deny tool invocations, particularly when AI systems can call
        external tools or perform actions.
      </p>

      <h2 className="docs__subtitle" id="why-human-confirmation-matters">
        Why Human Confirmation Matters
      </h2>
      <p className="docs__text">Human confirmation provides an important boundary between:</p>
      <blockquote className="docs__quote">“Robot found a possible solution.”</blockquote>
      ...
      <p className="docs__text">Craftly's goal is not to make agents blindly autonomous.</p>
      <p className="docs__text">
