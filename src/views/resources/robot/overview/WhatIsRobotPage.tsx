...
export default function WhatIsRobotPage() {
  return (
    <DocPage
      ...
      tocItems={[{ id: "what-is-craftly-robot", label: "What is Craftly Robot?" }]}
    >
      <p className="docs__text">
        Craftly Robot is an AI system being developed to act as a real-world assistant rather than
        only a conversational model.
      </p>
      <p className="docs__text">
        Its goal is to help users move from understanding a problem &rarr; finding the right
        resources &rarr; coordinating actions &rarr; completing the task.
      </p>
      <p className="docs__text">Robot is designed around capabilities such as:</p>
      ...
      <p className="docs__text">
        Robot is currently under active research and development, so its capabilities and
        architecture will continue to evolve.
      </p>
    </DocPage>
  );
}
