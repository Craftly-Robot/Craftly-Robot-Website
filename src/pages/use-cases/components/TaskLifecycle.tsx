      ...
      <div className="task-lifecycle__container" ref={containerRef}>
        ...
        <div className="task-lifecycle__card">
          <div className="task-lifecycle__card-header">
            ...
            <span
              className={`task-lifecycle__card-status status-${currentStage}`}
            >
              {STAGES[currentStage]}
            </span>
          </div>
          <h4 className="task-lifecycle__card-title">
            Q3 Financial Audit Review
          </h4>
          ...
          <div className="task-lifecycle__card-body">
            ...
            <div
              className={`task-lifecycle__evidence ${currentStage >= 2 ? "is-visible" : ""}`}
            >
              ...
              <div className="task-lifecycle__evidence-details">
                <span className="task-lifecycle__evidence-name">
                  audit_report_final.pdf
                </span>
                <span className="task-lifecycle__evidence-meta">
                  Attached by Executive • 2.4 MB
                </span>
              </div>
            </div>
          </div>
