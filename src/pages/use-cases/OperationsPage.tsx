    ...
    <div className="ucc-page-wrapper" ref={revealRef}>
      ...
      <FeatureSection
        ...
        description={
          <>
            <p>
              Craftly Workspace turns organizational instructions into
              structured work.
            </p>
            <p>
              Official instructions can move through the organization's
              reporting hierarchy. Every level has a clear responsibility for
              passing work forward, reviewing results, and escalating issues
              when necessary.
            </p>
          </>
        }
      ...
      <FeatureSection
        ...
        description={
          <>
            <p>
              Tasks are tracked from inception to completion with clear status
              boundaries.
            </p>
            <p>
              This strict lifecycle prevents work from being silently dropped
              and ensures accountability at every handoff.
            </p>
          </>
        }
      ...
      <FeatureSection
        ...
        description={
          <p style={{ margin: 0 }}>
            ...
            status updates and reports to follow the organizational graph up{" "}
            <br />
      ...
      <FeatureSection
        ...
        description={
          <p style={{ margin: 0 }}>
            Projects combine people, agents, codebase context, and requirements.
            <br />
            <br />
            From reading the initial <code>AGENT.md</code> specification to
            testing and submission, project <br />
            workflows become highly transparent processes rather than black
            boxes.
          </p>
        }
        visual={
      ...
      <FeatureSection
        ...
        description={
          <>
            <p>
              <strong>Structured Escalation:</strong> Operational blocking
              issues are handled cleanly through defined channels.
            </p>
            <p>
              Rather than sending an open-ended message, team members select the
              specific category of support they need, ensuring the request
              reaches the person actually equipped to solve it.
            </p>
          </>
        }
