...
export function AIStickyScroll() {
  ...
  const sections = [
    ...
    },
    {
      ...
      workflow:
        "Understand Codebase → Analyze Architecture → Plan → Implement → Test → Verify",
    ...
    },
    {
      ...
      workflow:
        "Research Agent ↓ Planning Agent ↓ Execution Agent ↓ Verification Agent",
        ...
        <div className="ai-sticky-text-col">
          {sections.map((section, idx) => (
            ...
            >
              ...
              >
                <span className="ucc-hero__eyebrow" style={{ margin: 0 }}>
                  {section.eyebrow}
                </span>
                {section.badge}
              </div>
              <h3
                ...
                style={{ fontSize: "32px", marginBottom: "var(--space-md)" }}
              >
                {section.title}
              </h3>
              ...
              <div className="ai-sticky-mobile-visual">{section.visual}</div>
