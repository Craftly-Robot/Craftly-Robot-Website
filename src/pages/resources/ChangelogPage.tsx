  ...
  },
  {
    ...
    accordions: [
      ...
      },
      {
        type: "Patches",
        count: 1,
        items: ["Security patch for third-party dependencies."],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    accordions: [
      ...
      },
      {
        type: "Fixes",
        count: 1,
        items: ["Fixed MCP timeouts occurring on large file uploads."],
      },
      {
        type: "Patches",
        count: 1,
        items: ["Various minor performance fixes."],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    accordions: [
      ...
      },
      {
        type: "Fixes",
        count: 1,
        items: ["Fixed an issue with user avatars not loading correctly."],
      },
      { type: "Patches", count: 0, items: [] },
    ],
  },
...
const robotReleases: ReleaseData[] = [
  {
    ...
    accordions: [
      ...
      },
      {
        type: "Fixes",
        count: 1,
        items: ["Fixed an issue with skill execution timeouts."],
      },
      {
        type: "Patches",
        count: 1,
        items: ["Minor memory leak patched in the reasoning engine."],
      },
    ],
  },
  {
    ...
    accordions: [
      ...
      },
      {
        type: "Fixes",
        count: 1,
        items: ["Resolved synchronization delays during multi-agent handoffs."],
      },
      { type: "Patches", count: 0, items: [] },
    ],
  },
  {
    ...
    accordions: [
      ...
      },
      {
        type: "Patches",
        count: 1,
        items: ["Patched minor visual bugs in the Task flow UI."],
      },
    ],
  },
  {
    ...
    accordions: [
      ...
      },
      {
        type: "Patches",
        count: 1,
        items: ["Security update for the logging framework."],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    accordions: [
      ...
      },
      {
        type: "Fixes",
        count: 1,
        items: ["Improved stability of long-running tool executions."],
      },
      { type: "Patches", count: 0, items: [] },
    ],
  },
    ...
    accordions: [
      {
        type: "Improvements",
        count: 1,
        items: ["Experimental agent memory and context system."],
      },
      { type: "Fixes", count: 0, items: [] },
      { type: "Patches", count: 0, items: [] },
    ],
    ...
    accordions: [
      {
        type: "Improvements",
        count: 1,
        items: ["Proof-of-concept for autonomous decision making."],
      },
      { type: "Fixes", count: 0, items: [] },
      { type: "Patches", count: 0, items: [] },
    ],
          ...
          <div className="changelog-hero">
            <div className="changelog-hero__top">
              ...
              <div className="changelog-actions">
                ...
                <a
                  href="https://x.com/Craftly_robot"
                  target="_blank"
