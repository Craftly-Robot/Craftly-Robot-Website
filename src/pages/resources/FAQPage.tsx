  ...
  return (
    <>
      ...
      tocItems={[
        ...
        {
          id: "faq-5",
          label: "5. Can I share my Private Key with someone else?",
        },
        ...
        {
          id: "faq-16",
          label: "16. What types of Support Requests can I create?",
        },
        {
          id: "faq-17",
          label: "17. When should I contact my Unit Commander through Support?",
        },
        {
          id: "faq-18",
          label: "18. What happens if I have a technical problem?",
        },
        ...
        { id: "faq-20", label: "20. What should I do after onboarding?" },
        {
          id: "faq-21",
          label:
            "21. I was assigned a project, but I don't understand how to work on it.",
        },
        ...
        {
          id: "faq-25",
          label: "25. Can I start working before my position is assigned?",
        },
        {
          id: "faq-26",
          label:
            "26. What should I do if I am blocked while working on a task?",
        },
        { id: "faq-27", label: "27. What if I cannot meet a task deadline?" },
        {
          id: "faq-28",
          label:
            "28. Can I modify the project structure or files however I want?",
        },
        {
          id: "faq-29",
          label: "29. What should I do before starting a project?",
        },
        {
          id: "faq-30",
          label: "30. Where can I find the resources I need for my work?",
        },
        ...
        { id: "faq-33", label: "33. What if I submit the wrong file?" },
        {
          id: "faq-34",
          label:
            "34. What if my task instructions are unclear or contradictory?",
        },
        {
          id: "faq-35",
          label:
        ...
        {
          id: "faq-37",
          label: "37. What if I need to report something sensitive?",
        },
        { id: "faq-38", label: "38. What if I am going to be unavailable?" },
        {
          id: "faq-39",
          label: "39. How can I improve my position within Craftly?",
        },
        { id: "faq-40", label: "40. What if I make a mistake?" },
        {
          id: "faq-41",
          label: "41. Is Craftly Workspace the same as Craftly Robot?",
        },
        {
          id: "faq-42",
          label:
        ...
        {
          id: "faq-43",
          label: "43. Can I change my department after joining?",
        },
        ...
        {
          id: "faq-51",
          label: "51. Can I edit my task submission after submitting it?",
        },
        {
          id: "faq-52",
          label: "52. Can I submit more than five files for a task?",
        },
        { id: "faq-53", label: "53. Who reviews my completed work?" },
        {
          id: "faq-54",
          label: "54. Can I use AI when working on a Craftly project?",
        },
        { id: "faq-55", label: "55. Can I use my own tools for a project?" },
        { id: "faq-56", label: "56. Are Craftly project files private?" },
        {
          id: "faq-57",
          label: "57. Do I need to push my code before submitting a project?",
        },
        {
          id: "faq-58",
          label:
            "58. What should I do if the project environment does not work?",
        },
        {
          id: "faq-59",
          label: "59. What if I discover a serious bug in Craftly Workspace?",
        },
        {
          id: "faq-60",
          label:
        ...
        {
          id: "faq-66",
          label: "66. Is completing onboarding enough to receive a salary?",
        },
        { id: "faq-67", label: "67. When will Craftly start paying salaries?" },
        {
          id: "faq-68",
          label: "68. How will I receive my salary in the future?",
        },
        ...
        {
          id: "faq-74",
          label: "74. Can I contact senior leadership directly?",
        },
        {
          id: "faq-75",
          label:
        ...
        {
          id: "faq-78",
          label: "78. Can my Robot communicate with another person's Robot?",
        },
        ...
        {
          id: "faq-82",
          label: "82. What if Robot does not understand my request?",
        },
        ...
        {
          id: "faq-85",
          label: "85. What happens if an agent gives incorrect information?",
        },
        {
          id: "faq-86",
          label: "86. Where can I learn about Craftly product updates?",
        },
        {
          id: "faq-87",
          label: "87. Where can I find the latest documentation?",
        },
        {
          id: "faq-88",
          label: "88. What if I cannot find an answer in the documentation?",
        },
      ]}
    >
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        5. Can I share my Private Key with someone else?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        6. What happens after I complete onboarding?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        8. How are official tasks assigned?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        10. How do I submit a completed task?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        11. What if I cannot complete my task?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        12. What are Projects in Workspace?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        13. Where can I find project instructions?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        16. What types of Support Requests can I create?
      </h3>
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        17. When should I contact my Unit Commander through Support?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        18. What happens if I have a technical problem?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        19. Can I suggest improvements to Craftly?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        20. What should I do after onboarding?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        22. How do I submit my completed project?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        23. How do I know what my role is?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        25. Can I start working before my position is assigned?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        27. What if I cannot meet a task deadline?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        29. What should I do before starting a project?
      </h3>
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        30. Where can I find the resources I need for my work?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        31. What happens after I submit my work?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        32. Can I submit unfinished work?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        33. What if I submit the wrong file?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        36. How should I communicate with my team?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        37. What if I need to report something sensitive?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        38. What if I am going to be unavailable?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        39. How can I improve my position within Craftly?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        41. Is Craftly Workspace the same as Craftly Robot?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        43. Can I change my department after joining?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        44. Can I work with another department?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        45. Can my role or position change?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        47. Can I request a different role?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        48. What happens if my task is reassigned?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        49. Can I ask for a deadline extension?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        50. What if my task submission is rejected?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        51. Can I edit my task submission after submitting it?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        52. Can I submit more than five files for a task?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        53. Who reviews my completed work?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        54. Can I use AI when working on a Craftly project?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        55. Can I use my own tools for a project?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        56. Are Craftly project files private?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        57. Do I need to push my code before submitting a project?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        59. What if I discover a serious bug in Craftly Workspace?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        61. Can I update my profile information?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        62. Who can see my personal information?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        64. Can my performance signal decrease?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        65. Is a high department ranking permanent?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        66. Is completing onboarding enough to receive a salary?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        67. When will Craftly start paying salaries?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        68. How will I receive my salary in the future?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        69. Can I leave Craftly after joining?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        70. What happens if I become inactive?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        71. Can I appeal an organizational decision?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        72. What if I disagree with my manager?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        74. Can I contact senior leadership directly?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        76. Is Craftly Robot the same as ChatGPT?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        77. Is Craftly Robot fully autonomous?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        78. Can my Robot communicate with another person's Robot?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        80. Does Agent-to-Agent Negotiation mean the agents can make deals
        without me?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        81. What happens if two agents cannot agree?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        82. What if Robot does not understand my request?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        83. Can Robot access everything on my phone?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        85. What happens if an agent gives incorrect information?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        86. Where can I learn about Craftly product updates?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        87. Where can I find the latest documentation?
      </h3>
      <p className="docs__text">
      ...
      <h3
        ...
        style={{ fontSize: "18px", marginTop: "24px" }}
      >
        88. What if I cannot find an answer in the documentation?
      </h3>
      <p className="docs__text">
