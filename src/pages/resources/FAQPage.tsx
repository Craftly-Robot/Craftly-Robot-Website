...
export default function FAQPage() {
  return (
    ...
    >
      ...
      <h3 className="docs__section-title" style={{ fontSize: '18px', marginTop: '32px' }}>1. What is Craftly Workspace?</h3>
      ...
      <h3 className="docs__section-title" style={{ fontSize: '18px', marginTop: '24px' }}>2. How do I join Craftly?</h3>
      <p className="docs__text">
      ...
      <h3 className="docs__section-title" style={{ fontSize: '18px', marginTop: '24px' }}>3. What is the Private Key?</h3>
      <p className="docs__text">
      ...
      <h3 className="docs__section-title" style={{ fontSize: '18px', marginTop: '24px' }}>4. What happens if I lose my Private Key?</h3>
      <p className="docs__text">
      ...
      <h3 className="docs__section-title" style={{ fontSize: '18px', marginTop: '24px' }}>5. Can I share my Private Key with someone else?</h3>
      <p className="docs__text">
      ...
      <h3 className="docs__section-title" style={{ fontSize: '18px', marginTop: '24px' }}>6. What happens after I complete onboarding?</h3>
      <p className="docs__text">
      ...
      <h3 className="docs__section-title" style={{ fontSize: '18px', marginTop: '24px' }}>7. What is the Command Chain?</h3>
      <p className="docs__text">
      ...
      <h3 className="docs__section-title" style={{ fontSize: '18px', marginTop: '24px' }}>8. How are official tasks assigned?</h3>
      <p className="docs__text">
      ...
      <h3 className="docs__section-title" style={{ fontSize: '18px', marginTop: '24px' }}>9. What is the Notice Board?</h3>
      <p className="docs__text">
      ...
      <h3 className="docs__section-title" style={{ fontSize: '18px', marginTop: '24px' }}>10. How do I submit a completed task?</h3>
      <p className="docs__text">
      ...
      <h3 className="docs__section-title" style={{ fontSize: '18px', marginTop: '24px' }}>11. What if I cannot complete my task?</h3>
      <p className="docs__text">
      ...
      <h3 className="docs__section-title" style={{ fontSize: '18px', marginTop: '24px' }}>12. What are Projects in Workspace?</h3>
      <p className="docs__text">
      ...
      <h3 className="docs__section-title" style={{ fontSize: '18px', marginTop: '24px' }}>13. Where can I find project instructions?</h3>
      <p className="docs__text">
      ...
      <h3 className="docs__section-title" style={{ fontSize: '18px', marginTop: '24px' }}>14. What is AGENT.md?</h3>
      <p className="docs__text">
      ...
      <h3 className="docs__section-title" style={{ fontSize: '18px', marginTop: '24px' }}>15. What is a Support Request?</h3>
      <p className="docs__text">
      ...
      <h3 className="docs__section-title" style={{ fontSize: '18px', marginTop: '24px' }}>16. What types of Support Requests can I create?</h3>
      <p className="docs__text">
      ...
      <h3 className="docs__section-title" style={{ fontSize: '18px', marginTop: '24px' }}>17. When should I contact my Unit Commander through Support?</h3>
      <p className="docs__text">
      ...
      <h3 className="docs__section-title" style={{ fontSize: '18px', marginTop: '24px' }}>18. What happens if I have a technical problem?</h3>
      <p className="docs__text">
      ...
      <h3 className="docs__section-title" style={{ fontSize: '18px', marginTop: '24px' }}>19. Can I suggest improvements to Craftly?</h3>
      <p className="docs__text">
        Yes. Use the Suggestions Support Request category to share ideas, improvements, or feedback that could make Craftly better.
      </p>

      <h3 className="docs__section-title" style={{ fontSize: '18px', marginTop: '24px' }}>20. What should I do after onboarding?</h3>
      <p className="docs__text">
      ...
      <h3 className="docs__section-title" style={{ fontSize: '18px', marginTop: '24px' }}>21. I was assigned a project, but I don't understand how to work on it. What should I do?</h3>
      <p className="docs__text">
      ...
      <h3 className="docs__section-title" style={{ fontSize: '18px', marginTop: '24px' }}>22. How do I submit my completed project?</h3>
      <p className="docs__text">
