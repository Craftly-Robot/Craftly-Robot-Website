        ...
        <div className="support-cards container">
          ...
          <a href="https://x.com/Craftly_robot" target="_blank" rel="noopener noreferrer" className="support-card">
            ...
            <div className="support-card__footer">
              <span className="support-card__link">Visit <span className="support-card__arrow"><svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="9 18 15 12 9 6"></polyline></svg></span></span>
            </div>
          </a>
