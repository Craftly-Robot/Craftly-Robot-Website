  ...
  return (
    <DocPage
      ...
      tocItems={[
        ...
        {
          id: "how-department-resources-work",
          label: "How Department Resources Work",
        },
        ...
        {
          id: "why-department-resources-matter",
          label: "Why Department Resources Matter",
        },
      ]}
    >
      ...
      <h2 className="docs__subtitle" id="git-project-submission">
