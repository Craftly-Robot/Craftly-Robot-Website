  ...
  return (
    <DocsLayout
      ...
      tocItems={[
        ...
        {
          id: "lose-key-logged-in",
          label: "If You Lose Your Key While Logged In",
        },
        {
          id: "lose-key-logged-out",
          label: "If You Lose Your Key While Logged Out",
        },
    ...
    >
      ...
      <h2 className="docs__section-title" id="lose-key-logged-in">
