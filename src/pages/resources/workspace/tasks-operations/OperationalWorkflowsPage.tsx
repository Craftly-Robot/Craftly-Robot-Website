  ...
  return (
    <DocsLayout 
      ...
      tocItems={[
        ...
        { id: 'practical-evaluation', label: 'Projects as Practical Evaluation' }
      ]}
    >
      ...
      <h2 className="docs__section-title" id="why-projects-matter">Why Projects Matter</h2>
      <p className="docs__text">
      ...
      <h2 className="docs__section-title" id="project-overview">Project Overview</h2>
      <p className="docs__text">
        Projects are available from:
      </p>
      <div className="docs__code-block" style={{ padding: '16px', backgroundColor: '#f8f9fa', borderRadius: '8px', textAlign: 'center', fontWeight: '500', marginBottom: '16px', color: '#202124' }}>
      ...
      <h2 className="docs__section-title" id="project-package">Project Package</h2>
      <p className="docs__text">
      ...
      <h2 className="docs__section-title" id="completing-a-project">Completing a Project</h2>
      <p className="docs__text">
      ...
      <h2 className="docs__section-title" id="practical-evaluation">Projects as Practical Evaluation</h2>
      <p className="docs__text">
