  ...
  return (
    <DocsLayout
      ...
      tocItems={[
        ...
        {
          id: "when-to-create",
          label: "When Should You Create a Support Request?",
        },
        { id: "how-support-requests-work", label: "How Support Requests Work" },
        { id: "write-clear-requests", label: "Write Clear Requests" },
        {
          id: "more-than-a-message",
          label: "A Support Request Is More Than a Message",
        },
      ]}
    >
      ...
      <p className="docs__text">Creating a support request is simple:</p>
