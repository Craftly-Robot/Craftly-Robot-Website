...
export default function DiscoverConnectPage() {
  return (
    ...
    >
      ...
      <p className="docs__text">
        These requirements can then be used to identify potentially relevant
        participants.
      </p>
      ...
      <p className="docs__text">
        A participant in the Craftly ecosystem may have an associated agent that
        can represent their available capabilities or services.
      </p>
      <p className="docs__text">
      ...
      <p className="docs__text">
        In broader agent interoperability work, capability discovery is a
        foundational concept: agents can publish metadata describing their
        identity, skills, endpoints, and interaction requirements so other
        agents can determine whether they are suitable for a task.
      </p>
      <p className="docs__text">
        Craftly Robot applies the same general idea to its own ecosystem and
        identity model.
      </p>
      ...
      <p className="docs__text">
        After identifying potentially relevant participants, Robot can initiate
        agent-to-agent communication.
      </p>
      <p className="docs__text">
        This can allow agents to exchange the information necessary to determine
