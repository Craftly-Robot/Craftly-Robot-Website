  ...
  return (
    ...
    >
      <div className="docs__breadcrumb">
        Documentation &gt; Craftly Robot &gt; Getting Started &gt; <strong>Agent-to-Agent Negotiation</strong>
      </div>
      ...
      <ul className="docs__list">
        <li><strong>1. Understand the request</strong><br/>Identify the required repair, location, deadline, maximum budget, and warranty requirement.</li>
        <li><strong>2. Discover relevant agents</strong><br/>Find agents representing laptop repair services in Dhaka that may be able to handle a MacBook display replacement.</li>
        <li><strong>3. Initiate communication</strong><br/>Send the repair request and relevant requirements to suitable service agents.</li>
        <li><strong>4. Exchange information</strong><br/>Agents can communicate about display availability, repair time, pricing, warranty, and other relevant service details.</li>
        <li><strong>5. Check alignment</strong><br/>Determine whether each service can meet the required deadline, budget, repair requirements, and warranty expectations.</li>
        <li><strong>6. Negotiate where necessary</strong><br/>If needed, agents can coordinate details such as final pricing, repair schedule, warranty terms, or other conditions.</li>
        <li><strong>7. Return the result</strong><br/>Your Robot presents the relevant options, including the services that best match your requirements.</li>
        <li><strong>8. Ask for human confirmation</strong><br/>Before making a consequential decision, Robot brings the options back to you for review and confirmation.</li>
      </ul>
      <p className="docs__text">
