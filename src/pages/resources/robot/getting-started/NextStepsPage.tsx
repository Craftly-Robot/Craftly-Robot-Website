...
export default function NextStepsPage() {
  return (
    ...
    >
      ...
      <p className="docs__text">
        <strong>AI should not stop at generating an answer when the user's real need is to get something done.</strong>
      </p>
      <p className="docs__text">
        Traditional conversational AI can be represented as:
      </p>
      <div className="docs__code">
        Ask &rarr; Understand &rarr; Answer
      </div>
      <p className="docs__text">
        Craftly Robot is being built around:
      </p>
      <div className="docs__code">
        Ask &rarr; Understand &rarr; Discover &rarr; Communicate &rarr; Negotiate &rarr; Coordinate &rarr; Human Approval &rarr; Action
      </div>
      <p className="docs__text">
