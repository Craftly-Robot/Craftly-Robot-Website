...
export default function RealWorldTaskCoordinationPage() {
  return (
    <DocsLayout 
      ...
      tocItems={[
        { id: 'real-world-task-coordination', label: 'Real-World Task Coordination' },
    ...
    >
      <div className="docs__breadcrumb">
        Documentation &gt; Craftly Robot &gt; Feature Overview &gt; <strong>Real-World Task Coordination</strong>
      </div>

      <h1 className="docs__title" id="real-world-task-coordination">Real-World Task Coordination</h1>
      ...
      <h2 className="docs__subtitle" id="from-goal-to-outcome">From Goal to Outcome</h2>
      <p className="docs__text">
        A real world task can be represented as:
      </p>
      <div className="docs__code-block">
        <pre>Goal → Requirements → Discovery → Communication → Negotiation → Coordination → Human Approval → Outcome</pre>
      </div>
      <p className="docs__text">
      ...
      <h2 className="docs__subtitle" id="task-state">Task State</h2>
      <p className="docs__text">
      ...
      <div className="docs__code-block">
        <pre>Pending → Discovering → Communicating → Negotiating → Waiting → Ready for Approval → Completed</pre>
      </div>
      <p className="docs__text">
      ...
      <h2 className="docs__subtitle" id="beyond-one-domain">Beyond One Domain</h2>
      <p className="docs__text">
      ...
      <h3 className="text-h3" style={{ marginTop: 'var(--space-xl)', marginBottom: 'var(--space-sm)' }}>Education</h3>
      <p className="docs__text">
        Finding tutors, teachers, mentors, or learning services based on specific requirements.
      </p>

      <h3 className="text-h3" style={{ marginTop: 'var(--space-xl)', marginBottom: 'var(--space-sm)' }}>Healthcare Coordination</h3>
      <p className="docs__text">
        Helping identify appropriate services or resources while maintaining strict privacy and human control.
      </p>

      <h3 className="text-h3" style={{ marginTop: 'var(--space-xl)', marginBottom: 'var(--space-sm)' }}>Local Services</h3>
      <p className="docs__text">
        Finding repair technicians, transportation, delivery, maintenance, or other service providers.
      </p>

      <h3 className="text-h3" style={{ marginTop: 'var(--space-xl)', marginBottom: 'var(--space-sm)' }}>Buying &amp; Selling</h3>
      <p className="docs__text">
        Helping users discover suitable buyers or sellers and coordinate communication around a transaction.
      </p>

      <h3 className="text-h3" style={{ marginTop: 'var(--space-xl)', marginBottom: 'var(--space-sm)' }}>Humanitarian Coordination</h3>
      <p className="docs__text">
        Tasks such as finding blood donors, locating relevant resources, or coordinating volunteers.
      </p>

      <h3 className="text-h3" style={{ marginTop: 'var(--space-xl)', marginBottom: 'var(--space-sm)' }}>Business Services</h3>
      <p className="docs__text">
      ...
      <h2 className="docs__subtitle" id="current-status">Current Status</h2>
      <p className="docs__text">
...
↓
Reliable Agentic Reasoning
↓
Agent Discovery
↓
Agent-to-Agent Coordination
↓
Real World Task Execution</pre>
      </div>
      <p className="docs__text">
      ...
      <h2 className="docs__subtitle" id="the-long-term-goal">The Long Term Goal</h2>
      <p className="docs__text">
