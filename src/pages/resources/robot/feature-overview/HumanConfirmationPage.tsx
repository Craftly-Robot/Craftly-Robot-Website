  ...
  return (
    <DocsLayout 
      ...
      tocItems={[
        ...
        { id: 'what-requires-human-control', label: 'What Requires Human Control' },
        { id: 'why-human-confirmation-matters', label: 'Why Human Confirmation Matters' },
    ...
    >
      ...
      <h2 className="docs__subtitle" id="what-robot-can-do">What Robot Can Do</h2>
      <p className="docs__text">
        Robot can assist with activities such as:
      </p>
      <div className="docs__code-block">
        <pre>Understanding the request → Discovering relevant agents → Asking questions → Comparing information → Communicating → Negotiating possible conditions</pre>
      </div>
      <p className="docs__text">
        These activities reduce the amount of manual coordination required from the user.
      </p>

      <h2 className="docs__subtitle" id="what-requires-human-control">What Requires Human Control</h2>
      <p className="docs__text">
...
Consequential Action</pre>
      ...
      <h2 className="docs__subtitle" id="why-human-confirmation-matters">Why Human Confirmation Matters</h2>
      <p className="docs__text">
      ...
      <h2 className="docs__subtitle" id="craftlys-principle">Craftly's Principle</h2>
      <p className="docs__text">
