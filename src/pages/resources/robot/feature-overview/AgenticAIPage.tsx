  ...
  return (
    <DocsLayout 
      ...
      tocItems={[
        ...
        { id: 'from-conversation-to-action', label: 'From Conversation to Action' },
        { id: 'where-robot-is-today', label: 'Where Robot Is Today' },
        { id: 'what-we-are-building-toward', label: 'What We Are Building Toward' }
      ]}
    >
      ...
      <h2 className="docs__subtitle" id="from-conversation-to-action">From Conversation to Action</h2>
      <p className="docs__text">
      ...
      <div className="docs__code-block">
        <pre>User → Understanding → Reasoning → Planning → Discovery → Coordination → Human Approval → Action</pre>
      </div>
      <p className="docs__text">
      ...
      <h2 className="docs__subtitle" id="where-robot-is-today">Where Robot Is Today</h2>
      <p className="docs__text">
      ...
      <div className="docs__code-block">
        <pre>Strong Conversational Model → Reliable Reasoning → Tool &amp; Context Integration → Agentic Workflows → Multi-Agent Coordination</pre>
      </div>
      <p className="docs__text">
        The exact capabilities available to users can therefore change as research progresses.
      </p>

      <h2 className="docs__subtitle" id="what-we-are-building-toward">What We Are Building Toward</h2>
      <p className="docs__text">
