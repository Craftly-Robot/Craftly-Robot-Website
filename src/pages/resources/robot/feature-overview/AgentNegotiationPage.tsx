...
export default function AgentNegotiationPage() {
  return (
    ...
    >
      ...
      <h1 className="docs__title" id="agent-to-agent-negotiation">Agent-to-Agent Negotiation</h1>
      ...
      <h2 className="docs__subtitle" id="how-it-works">How It Works</h2>
      <p className="docs__text">
...
Real World Action</pre>
      ...
      <h2 className="docs__subtitle" id="why-it-matters">Why It Matters</h2>
      <p className="docs__text">
