        ...
        <div className="container" style={{ maxWidth: '1280px', margin: '0 auto' }}>
          ...
          <div className="abstracted-ui-grid">
            <div className="abstracted-ui-feature reveal">
              <img src="/assets/Craftly_Robot/1.1.webp" alt="Robot detail 1.1" className="product-showcase-image" style={{ width: '100%', maxWidth: '320px', margin: '0 auto' }} />
            ...
            <div className="abstracted-ui-feature reveal reveal-delay-1">
              <img src="/assets/Craftly_Robot/1.2.webp" alt="Robot detail 1.2" className="product-showcase-image" style={{ width: '100%', maxWidth: '320px', margin: '0 auto' }} />
          ...
          <div className="abstracted-ui-grid" style={{ marginTop: 'var(--space-2xl)' }}>
            <div className="abstracted-ui-feature reveal">
              <img src="/assets/Craftly_Robot/2.1.webp" alt="Robot detail 2.1" className="product-showcase-image" style={{ width: '100%', maxWidth: '320px', margin: '0 auto' }} />
            ...
            <div className="abstracted-ui-feature reveal reveal-delay-1">
              <img src="/assets/Craftly_Robot/2.2.webp" alt="Robot detail 2.2" className="product-showcase-image" style={{ width: '100%', maxWidth: '320px', margin: '0 auto' }} />
          ...
          <div className="abstracted-ui-grid" style={{ marginTop: 'var(--space-2xl)' }}>
            <div className="abstracted-ui-feature reveal">
              <img src="/assets/Craftly_Robot/3.1.webp" alt="Robot detail 3.1" className="product-showcase-image" style={{ width: '100%', maxWidth: '320px', margin: '0 auto' }} />
            ...
            <div className="abstracted-ui-feature reveal reveal-delay-1">
              <img src="/assets/Craftly_Robot/3.2.webp" alt="Robot detail 3.2" className="product-showcase-image" style={{ width: '100%', maxWidth: '320px', margin: '0 auto' }} />
          ...
          <div className="abstracted-ui-grid" style={{ marginTop: 'var(--space-2xl)' }}>
            <div className="abstracted-ui-feature reveal">
              <img src="/assets/Craftly_Robot/4.1.webp" alt="Robot detail 4.1" className="product-showcase-image" style={{ width: '100%', maxWidth: '320px', margin: '0 auto' }} />
            ...
            <div className="abstracted-ui-feature reveal reveal-delay-1">
              <img src="/assets/Craftly_Robot/4.2.webp" alt="Robot detail 4.2" className="product-showcase-image" style={{ width: '100%', maxWidth: '320px', margin: '0 auto' }} />
          ...
          <div className="abstracted-ui-grid" style={{ marginTop: 'var(--space-2xl)' }}>
            <div className="abstracted-ui-feature reveal">
              <img src="/assets/Craftly_Robot/5.1.webp" alt="Robot detail 5.1" className="product-showcase-image" style={{ width: '100%', maxWidth: '320px', margin: '0 auto' }} />
            ...
            <div className="abstracted-ui-feature reveal reveal-delay-1">
              <img src="/assets/Craftly_Robot/5.2.webp" alt="Robot detail 5.2" className="product-showcase-image" style={{ width: '100%', maxWidth: '320px', margin: '0 auto' }} />
          ...
          <div className="abstracted-ui-grid" style={{ marginTop: 'var(--space-2xl)' }}>
            <div className="abstracted-ui-feature reveal">
              <img src="/assets/Craftly_Robot/7.1.webp" alt="Robot detail 7.1" className="product-showcase-image" style={{ width: '100%', maxWidth: '320px', margin: '0 auto' }} />
            ...
            <div className="abstracted-ui-feature reveal reveal-delay-1">
              <img src="/assets/Craftly_Robot/7.2.webp" alt="Robot detail 7.2" className="product-showcase-image" style={{ width: '100%', maxWidth: '320px', margin: '0 auto' }} />
