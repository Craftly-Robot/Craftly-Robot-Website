...
const AgentNegotiationPage = lazy(
  () => import("./pages/use-cases/AgentNegotiationPage"),
);
...
const SalaryCompensationPage = lazy(
  () => import("./pages/resources/SalaryCompensationPage"),
);
const WhatIsRobotPage = lazy(
  () => import("./pages/resources/robot/overview/WhatIsRobotPage"),
);
const RobotArchitecturePage = lazy(
  () => import("./pages/resources/robot/overview/RobotArchitecturePage"),
);
const HowRobotWorksPage = lazy(
  () => import("./pages/resources/robot/overview/HowRobotWorksPage"),
);
const AgentModelPage = lazy(
  () => import("./pages/resources/robot/overview/AgentModelPage"),
);
const CurrentStatusPage = lazy(
  () => import("./pages/resources/robot/overview/CurrentStatusPage"),
);
const LongTermVisionPage = lazy(
  () => import("./pages/resources/robot/overview/LongTermVisionPage"),
);

const RobotBeforeYouStartPage = lazy(
  () => import("./pages/resources/robot/getting-started/BeforeYouStartPage"),
);
const RobotInstallCraftlyRobotPage = lazy(
  () =>
    import("./pages/resources/robot/getting-started/InstallCraftlyRobotPage"),
);
const RobotSignInPrivateKeyPage = lazy(
  () => import("./pages/resources/robot/getting-started/SignInPrivateKeyPage"),
);
const RobotYourFirstRobotPage = lazy(
  () => import("./pages/resources/robot/getting-started/YourFirstRobotPage"),
);
const RobotDiscoverConnectPage = lazy(
  () => import("./pages/resources/robot/getting-started/DiscoverConnectPage"),
);
const RobotAgentNegotiationGSPage = lazy(
  () =>
    import("./pages/resources/robot/getting-started/AgentNegotiationGSPage"),
);
const RobotRunFirstTaskPage = lazy(
  () => import("./pages/resources/robot/getting-started/RunFirstTaskPage"),
);
const RobotNextStepsPage = lazy(
  () => import("./pages/resources/robot/getting-started/NextStepsPage"),
);

const RobotAgenticAIPage = lazy(
  () => import("./pages/resources/robot/feature-overview/AgenticAIPage"),
);
const RobotAgentNegotiationPage = lazy(
  () => import("./pages/resources/robot/feature-overview/AgentNegotiationPage"),
);
const RobotHumanConfirmationPage = lazy(
  () =>
    import("./pages/resources/robot/feature-overview/HumanConfirmationPage"),
);
const RobotRealWorldTaskCoordinationPage = lazy(
  () =>
    import("./pages/resources/robot/feature-overview/RealWorldTaskCoordinationPage"),
);

const WhatIsWorkspacePage = lazy(
  () => import("./pages/resources/workspace/overview/WhatIsWorkspacePage"),
);
const HowWorkspaceWorksPage = lazy(
  () => import("./pages/resources/workspace/overview/HowWorkspaceWorksPage"),
);
const WorkspaceStructurePage = lazy(
  () => import("./pages/resources/workspace/overview/WorkspaceStructurePage"),
);
const CoreConceptsPage = lazy(
  () => import("./pages/resources/workspace/overview/CoreConceptsPage"),
);

const OrgStructurePage = lazy(
  () => import("./pages/resources/workspace/organization/OrgStructurePage"),
);
const DepartmentsPage = lazy(
  () => import("./pages/resources/workspace/organization/DepartmentsPage"),
);
const ReportingStructurePage = lazy(
  () =>
    import("./pages/resources/workspace/organization/ReportingStructurePage"),
);
const MembersPage = lazy(
  () => import("./pages/resources/workspace/people-roles/MembersPage"),
);
const RolesPage = lazy(
  () => import("./pages/resources/workspace/people-roles/RolesPage"),
);
const PermissionsPage = lazy(
  () => import("./pages/resources/workspace/people-roles/PermissionsPage"),
);
const ManagersPage = lazy(
  () => import("./pages/resources/workspace/people-roles/ManagersPage"),
);
const AccessControlPage = lazy(
  () => import("./pages/resources/workspace/people-roles/AccessControlPage"),
);

const TasksPage = lazy(
  () => import("./pages/resources/workspace/tasks-operations/TasksPage"),
);
const TaskAssignmentPage = lazy(
  () =>
    import("./pages/resources/workspace/tasks-operations/TaskAssignmentPage"),
);
const TaskEvidencePage = lazy(
  () => import("./pages/resources/workspace/tasks-operations/TaskEvidencePage"),
);
const SupportRequestsPage = lazy(
  () =>
    import("./pages/resources/workspace/tasks-operations/SupportRequestsPage"),
);
const NoticesPage = lazy(
  () => import("./pages/resources/workspace/tasks-operations/NoticesPage"),
);
const OperationalWorkflowsPage = lazy(
  () =>
    import("./pages/resources/workspace/tasks-operations/OperationalWorkflowsPage"),
);

const ChainOfCommandPage = lazy(
  () => import("./pages/resources/workspace/communication/ChainOfCommandPage"),
);
const ReportingCommunicationPage = lazy(
  () =>
    import("./pages/resources/workspace/communication/ReportingCommunicationPage"),
);
const NotificationsPage = lazy(
  () => import("./pages/resources/workspace/communication/NotificationsPage"),
);

const OrgResourcesPage = lazy(
  () => import("./pages/resources/workspace/resources/OrgResourcesPage"),
);
const DeptResourcesPage = lazy(
  () => import("./pages/resources/workspace/resources/DeptResourcesPage"),
);
const TrainingPage = lazy(
  () => import("./pages/resources/workspace/resources/TrainingPage"),
);

const WelcomeSetupPage = lazy(
  () => import("./pages/resources/workspace/onboarding/WelcomeSetupPage"),
);
const OnboardingQuestionsPage = lazy(
  () =>
    import("./pages/resources/workspace/onboarding/OnboardingQuestionsPage"),
);
const AgreementsPage = lazy(
  () => import("./pages/resources/workspace/onboarding/AgreementsPage"),
);
const PrivateKeyPage = lazy(
  () => import("./pages/resources/workspace/onboarding/PrivateKeyPage"),
);
const CompletingOnboardingPage = lazy(
  () =>
